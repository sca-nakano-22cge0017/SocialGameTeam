...
public class MainGameGuage : MonoBehaviour
{
    ...
    [SerializeField, Header("最大時画像変更するか")] private bool isSpriteChange = false;
    [SerializeField, Header("最大時の画像")] private Sprite maxSprite;
    [SerializeField, Header("最大時じゃないときの画像")] private Sprite notMaxSprite;
